                ...
                <ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="about-us">
							<li><a href="newEmployee">Add/Updtate Employee</a></li>
							<li><a href="newProject">Add/Updtate Project</a></li>
							<li><a href="newSalary">Add/Updtate salary report</a></li>
						</ul>
					</li>
                    <li>
                        <a href="#">Contact</a>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <a href="/home.jsp" class="btn btn-primary btn-lg">Engage Now</a>
            </div>
        </div>
    </header>
